...
/**
* <h1>EvalEx - Java CExpressionUtl Evaluator</h1>
* 
* <h2>Introduction</h2>
...
* <pre>
  ...
  CExpressionUtl expression = new CExpressionUtl("1+1/3");
  result = expression.eval():
  expression.setPrecision(2);
  result = expression.eval():
  
  result = new CExpressionUtl("(3.4 + -4.1)/2").eval();
  
  result = new CExpressionUtl("SQRT(a^2 + b^2").with("a","2.4").and("b","9.253").eval();
  
  BigDecimal a = new BigDecimal("2.4");
  BigDecimal b = new BigDecimal("9.235");
  result = new CExpressionUtl("SQRT(a^2 + b^2").with("a",a).and("b",b).eval();
  
  result = new CExpressionUtl("2.4/PI").setPrecision(128).setRoundingMode(RoundingMode.UP).eval();
  
  result = new CExpressionUtl("random() > 0.5").eval();
 
  result = new CExpressionUtl("not(x<7 || sqrt(max(x,9)) <= 3))").with("x","22.9").eval();
* </pre>
* <br>
...
* <h2>Add Custom Operators</h2>
 ...
 Custom operators can be added easily, simply create an instance of `CExpressionUtl.Operator` and add it to the expression.
...
* 
* <pre>
 CExpressionUtl e = new CExpressionUtl("2.1234 >> 2");
* 
...
* <h2>Add Custom Functions</h2>
 ...
 Adding custom functions is as easy as adding custom operators. Create an instance of `CExpressionUtl.Function`and add it to the expression.
...
* <br>
* <pre>
 CExpressionUtl e = new CExpressionUtl("2 * average(12,4,8)");
...
public class CExpressionUtl {
	 ...
	 */
	private Map<String, Operator> operators = new HashMap<String, CExpressionUtl.Operator>();

	/**
	 * All defined functions with name and implementation.
	 */
	private Map<String, Function> functions = new HashMap<String, CExpressionUtl.Function>();
	 ...
	 */
	public CExpressionUtl(String expression) {
	 ...
	 */
	public CExpressionUtl setPrecision(int precision) {
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public CExpressionUtl setRoundingMode(RoundingMode roundingMode) {
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public CExpressionUtl setVariable(String variable, BigDecimal value) {
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public CExpressionUtl setVariable(String variable, String value) {
		if (isNumber(value))
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public CExpressionUtl with(String variable, BigDecimal value) {
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public CExpressionUtl and(String variable, String value) {
		return setVariable(variable, value);
	}
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public CExpressionUtl and(String variable, BigDecimal value) {
		return setVariable(variable, value);
	}
	 ...
	 * @return The expression, allows to chain methods.
	 */
	public CExpressionUtl with(String variable, String value) {
		return setVariable(variable, value);
	}
